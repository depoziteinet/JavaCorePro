...
public class MyServer {
    ...
    public synchronized void sendMsg(String from, String msg, String nik){
        ClientHandler receiver;
        if(clients.containsKey(nik)){
            receiver = clients.get(nik);
            receiver.sendMsg(from + ": " + msg);
        }
        else {
            receiver = clients.get(from);
            receiver.sendMsg("Получателя: " + nik + ", в чате нет!");
        }
    }
