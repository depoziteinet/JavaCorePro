...
public class Controller implements Initializable {
    ...
    public void getNicknameFromList(){
        MultipleSelectionModel<String> nickNameFromList = clientsList.getSelectionModel();
        nickNameFromList.selectedItemProperty().addListener((observable, oldValue, newValue) -> network.setNicknameFromList(newValue));
    }
        ...
        network.setCallOnMsgReceived(args -> {
            ...
            if (msg.startsWith("/clients ")) {
                ...
                Platform.runLater(() -> {
                    ...
                    clientsList.getItems().add("Отправить всем");
