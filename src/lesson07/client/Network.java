...
public class Network implements Closeable {
    ...
    public void setNicknameFromList(String nickFromList){
         this.nickFromList = nickFromList;
    }
    ...
    public boolean sendMsg(String msg) {
        ...
        try {
            if(nickFromList.equals("Отправить всем") || nickFromList.equals(""))
                out.writeUTF(msg);
            else out.writeUTF("/w " + nickFromList + " " + msg);
